...
<table width="100%" border="0" cellspacing="0" cellpadding="5">
              ...
              <table border="0" cellspacing="0" cellpadding="2">
                <tr>
                  ...
                  <td valign="top"><?php
					  ...
					  $myCalendar->setDate(date('d'), date('m'), 2040);
					  ...
					  $myCalendar->setTimezone("Australia/Melbourne"); //Asia/Tokyo, America/Montreal
  ...
  <p>
    ...
    <input type="button" name="button4" id="button4" value="Set calendar value to today" onClick="javascript:setCalendarValue1();">
	...
	//-->
              ...
              <p><b>Code:</b></p>
              <pre>&lt;?php<br>	  $myCalendar = new tc_calendar(&quot;date2&quot;);<br>	  $myCalendar-&gt;setIcon(&quot;calendar/images/iconCalendar.gif&quot;);<br>	  $myCalendar-&gt;setDate(date('d'), date('m'), date('Y'));<br>	  $myCalendar-&gt;setPath(&quot;calendar/&quot;);<br>	  $myCalendar-&gt;setYearInterval(1890, 2080);<br>					  <br>	  $myCalendar-&gt;dateAllow('1890-01-01', '2045-05-01', false);<br>					  <br>	  $myCalendar-&gt;setSpecificDate(array(&quot;2039-01-10&quot;, &quot;2039-01-13&quot;, &quot;2039-01-23&quot;), 0, 'month');<br>					  <br>	  $myCalendar-&gt;startMonday(true);<br>	  $myCalendar-&gt;showWeeks(true);  <br>					  <br>	  //Tooltips<br>	  $myCalendar-&gt;setToolTips(array(&quot;2013-07-02&quot;, &quot;2013-07-15&quot;, &quot;2013-07-25&quot;), 'ŞŢĂÎÂ şţăîâ אי אפשר test!', '');<br>	  $myCalendar-&gt;setToolTips(array(&quot;2013-06-06&quot;, &quot;2013-06-01&quot;, &quot;2013-06-05&quot;), 'אי אפשר לבחור תאריך זה', 'month');<br>	  $myCalendar-&gt;setToolTips(array(&quot;1969-07-06&quot;, &quot;2040-07-01&quot;, &quot;2013-06-05&quot;), 'Δεν επιτρέπετε η επιλογή αυτής της ημέρας', 'month');<br>	  $myCalendar-&gt;setToolTips(array(&quot;1969-07-06&quot;, &quot;2040-07-01&quot;, &quot;2013-06-05&quot;), 'الإصدار الخاص بي ليس لديها الدعم للعام 2038 وفيما بعد!', 'month');<br>	  $myCalendar-&gt;setToolTips(array(&quot;1969-07-06&quot;, &quot;2040-07-01&quot;, &quot;2013-06-05&quot;), 'の間の日付を選択してください', 'month');<br>	  $myCalendar-&gt;setToolTips(array(&quot;1969-07-06&quot;, &quot;2040-07-01&quot;, &quot;2013-06-05&quot;), '올바르지 않은 값입니다', 'month');<br>          $myCalendar-&gt;setToolTips(array(&quot;2013-06-06&quot;, &quot;2013-06-11&quot;, &quot;2013-06-15&quot;), 'और बाद के वर्षों का समर्थन नहीं है!', 'month');<br>          $myCalendar-&gt;setToolTips(array(&quot;2013-07-06&quot;, &quot;2013-01-01&quot;, &quot;2013-12-25&quot;), 'วันนี้ไม่ได้รับอนุญาตให้มีการเลือก', 'year');<br>	  $myCalendar-&gt;setToolTips(array(&quot;2013-07-06&quot;, &quot;2013-07-15&quot;, &quot;2013-07-25&quot;), '请选择日期%s之前一个', '');<br>					  <br>	  $myCalendar-&gt;setTimezone(&quot;Australia/Melbourne&quot;);
	  $myCalendar-&gt;writeScript();<br>	  ?&gt;</pre>
              ...
              <p><b>Code:</b></p>
              <pre>&lt;?php<br>	  $myCalendar = new tc_calendar(&quot;date1&quot;, true);<br>	  $myCalendar-&gt;setIcon(&quot;calendar/images/iconCalendar.gif&quot;);<br>	  $myCalendar-&gt;setDate(01, 03, 1960);<br>	  $myCalendar-&gt;setPath(&quot;calendar/&quot;);<br>	  $myCalendar-&gt;setYearInterval(1960, 2015);<br>	  $myCalendar-&gt;dateAllow('2010-01-01', '2015-03-01');<br>	  $myCalendar-&gt;setSpecificDate(array(&quot;2011-04-01&quot;, &quot;2011-04-13&quot;, &quot;2011-04-25&quot;), 0, 'month');<br>	  $myCalendar-&gt;setOnChange(&quot;myChanged('test')&quot;);<br>	  $myCalendar-&gt;writeScript();<br>	  ?&gt;
...
<blockquote>
  ...
  <p>Ex 1. $myCalendar-&gt;setSpecificDate(array(&quot;2011-04-22&quot;));<br>
    ...
    Ex 3. $myCalendar-&gt;setSpecificDate(array(&quot;2011-04-22&quot;), 0, 'year'); //disable 22 Apr on every year </p>
              ...
              <p><i>setToolTips (array dates, string tooltip, string recursive)</i> - <b><font color="red">New!</font></b></p>
              <blockquote>
				...
				<p>Ex 1. $myCalendar-&gt;setToolTips(array(&quot;2013-07-06&quot;, &quot;2013-07-15&quot;, &quot;2013-07-25&quot;), &quot;Tooltip Test&quot;);<br />
				  Ex 2. $myCalendar-&gt;setToolTips(array(&quot;2013-06-06&quot;, &quot;2013-06-01&quot;, &quot;2013-06-05&quot;), &quot;Monthly Tooltip&quot;, &quot;month&quot;);<br />
				  Ex 3. $myCalendar-&gt;setToolTips(array(&quot;2013-06-06&quot;, &quot;2013-07-11&quot;, &quot;2013-09-15&quot;), &quot;Second Monthly Event&quot;, &quot;month&quot;);<br />
				  Ex 4. $myCalendar-&gt;setToolTips(array(&quot;2013-06-06&quot;, &quot;2013-01-01&quot;, &quot;2013-12-25&quot;), &quot;Yearly Event&quot;, &quot;year&quot;);<br />
				  Ex 5. $myCalendar-&gt;setToolTips(array(&quot;2013-07-06&quot;, &quot;2013-07-15&quot;, &quot;2013-07-25&quot;), &quot;Second Tooltip test&quot;);              </p>
              </blockquote>
</blockquote>
