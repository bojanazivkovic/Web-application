...
<div id="levi_tekst">
<h1>Unos novog clana</h1>

<div class="forma">
 <form action="insertUBazu.php" method="post">
<label>Ime:</label> <input type="text" size="20" name="ime"><br>
<label>Prezime:</label> <input type="text" size="20" name="prezime"><br>
<label>Telefon:</label> <input type="text" size="20" name="telefon"><br>
<div class="posalji">
...
<h1>Brisanje clanova</h1>
<h4>Upisite broj clanske karte:</h4>
<div class="forma">
 <form action="brisanjeIzBaze.php" method="post">
<label>Br.cl.k:</label> <input type="text" size="20" name="brck"><br>
<div class="posalji">
...
<h4>Izaberite clana za brisanje:</h4>

<form action="brisanjeIzListe.php" method="post">
...
<?php
	...
	$ck = $row ['Clan_ID'];
    $clan = $row['Clan_Ime']; 
	$clanp = $row['Clan_Prezime'];
    echo "<option>" . $ck . "&nbsp;" . $clan . "&nbsp;" . $clanp . "</option>"; 
    } 
    ?>
    </select>
    <input type="submit" value="Obrisi" name="obrisi">
